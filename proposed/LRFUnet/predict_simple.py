...
def main():
    ...
    if model == "3d_cascade_fullres" and lowres_segmentations is None:
        ...
        predict_from_folder(model_folder_name, input_folder, lowres_output_folder, folds, False,
                            ...
                            factorization=factorization, low_rank_conv=low_rank_conv, LRF_r=LRF_r, Tucker_threshokd=Tucker_threshold, start_pos=start_pos, use_SE=use_SE, use_CBAM=use_CBAM, use_ASPP=use_ASPP)
