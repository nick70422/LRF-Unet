...
# 設定資料夾路徑
base_dir = '/mnt/c/Nick/研究/medical/code/交接程式/proposed/LRFUnet'

CSM_start_task_num = 581
CSM_task_name = "CSMAbdominalSeg"
CSM_classes = {1: "Abdominal muscles", 2: "VAT"} #CSM
mendeley_start_task_num = 576
mendeley_task_name = "AbdominalSeg"
mendeley_classes = {1: "SAT", 2: "VAT", 3: "Organs", 4: "Spine", 5: "Spine muscles", 6: "Abdominal muscles"} #mendeley
CSMHuOtsu_start_task_num = 606
CSMHuOtsu_task_name = "CSMAbdominalSegHuOtsu"
CSMHuOtsu_classes = {1: "Abdominal muscles", 2: "VAT"} #CSM 0 cropped

start_task_num = CSM_start_task_num
task_name = CSM_task_name
classes = CSM_classes
#start_task_num = mendeley_start_task_num
#task_name = mendeley_task_name
#classes = mendeley_classes
#start_task_num = CSMHuOtsu_start_task_num
#task_name = CSMHuOtsu_task_name
#classes = CSMHuOtsu_classes
    ...
    for fold_name, paths in folds.items():
        ...
        for pred_file in tqdm(prediction_files):
            ...
            for class_value, class_name in classes.items():
                ...
                #debug
                if math.isinf(hd95): print(case_dir)
...
# 保存Excel文件
wb.save(f'{base_dir}/results/testing_result.xlsx')
