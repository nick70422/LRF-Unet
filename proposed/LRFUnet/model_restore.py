...
def restore_model(pkl_file, checkpoint=None, train=False, fp16=None, finetune=None, LoRA_r=4, factorization=None, low_rank_conv=None, LRF_r=16, Tucker_threshold=0.95, start_pos=0, use_SE=False, use_CBAM=False, use_ASPP=False):
    """
...
#    tr = recursive_find_python_class([search_in], name, current_module="nnunet.training.network_training")
    ...
    trainer = tr(*init, is_test=True, finetune=finetune, LoRA_r=LoRA_r, factorization=factorization, low_rank_conv=low_rank_conv, LRF_r=LRF_r, Tucker_threshold=Tucker_threshold, start_pos=start_pos, use_SE=use_SE, use_CBAM=use_CBAM, use_ASPP=use_ASPP)
...
def load_model_and_checkpoint_files(folder, folds=None, mixed_precision=None, checkpoint_name="model_best", finetune=None, LoRA_r=4, factorization=None, low_rank_conv=None, LRF_r=16, Tucker_threshold=0.95, start_pos=0, use_SE=False, use_CBAM=False, use_ASPP=False):
    """
    ...
    trainer = restore_model(join(folds[0], "%s.model.pkl" % checkpoint_name), fp16=mixed_precision, finetune=finetune, LoRA_r=LoRA_r, factorization=factorization, low_rank_conv=low_rank_conv, LRF_r=LRF_r, Tucker_threshold=Tucker_threshold, start_pos=start_pos, use_SE=use_SE, use_CBAM=use_CBAM, use_ASPP=use_ASPP)
