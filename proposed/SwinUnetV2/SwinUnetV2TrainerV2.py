...
from SwinUnetV2 import SwinUnetV2
...
class SwinUnetV2TrainerV2(nnUNetTrainer):
    """
    Info for Fabian: same as internal nnUNetTrainerV2_2
    """

    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False, test=False, use_LoRA=False, LoRA_location='QKVO', supervised=False, SSL=False):
    ...
    def initialize(self, training=True, force_load_plans=False, resume=False):
        """
        ...
        if not self.was_initialized:
            ...
            self.initialize_network(resume)
    ...
    def initialize_network(self, resume=False):
        """
        - momentum 0.99
        - SGD instead of Adam
        ...
        #self.network = SwinUnetV2(3, 224, self.num_classes, conv_op, resume, self.is_test, self.use_LoRA, self.use_LoRA_locatio, self.supervised, self.SSL)
        self.network = SwinUnetV2(3, 512, self.num_classes, conv_op, resume, self.is_test, self.use_LoRA, self.LoRA_location, self.supervised, self.SSL)
        #self.network = SwinUnetV2(3, 256, self.num_classes, conv_op, resume, self.is_test, self.use_LoRA, self.LoRA_location, self.supervised, self.SSL)
    ...
    def run_online_evaluation(self, output, target):
        ...
        :return:
        """
        #no deep supervision for Swin-Unet
        #target = target[0]
        #output = output[0]
    ...
    def plot_network_architecture(self):
        print("network plotting has been skipped in Swin-Unet v2")