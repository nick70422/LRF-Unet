...
def main():
    ...
    parser.add_argument("--finetune", default=None,
                        help="finetune type, change to LoRA if training with LoRA")
    ...
    #LoRA debug
    #print(f"args.finetune: {finetune}")
    ...
    if model == "3d_cascade_fullres" and lowres_segmentations is None:
        ...
        predict_from_folder(model_folder_name, input_folder, lowres_output_folder, folds, False,
                            ...
                            step_size=step_size,
                            finetune=finetune, LoRA_r=LoRA_r,
                            factorization=factorization, low_rank_conv=low_rank_conv, LRF_r=LRF_r, Tucker_threshokd=Tucker_threshold, start_pos=start_pos, use_SE=use_SE, use_CBAM=use_CBAM, use_ASPP=use_ASPP, use_attn=use_attn)
