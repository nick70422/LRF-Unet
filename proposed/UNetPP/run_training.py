...
def main():
    ...
    parser.add_argument("--use_attn", default=False,
                        help="use which attn in the bottom of every encoder block")
    ...
    trainer = trainer_class(plans_file, fold, output_folder=output_folder_name, dataset_directory=dataset_directory,
                            ...
                            factorization=factorization, low_rank_conv=low_rank_conv, LRF_r=LRF_r, Tucker_threshold=Tucker_threshold, start_pos=start_pos, use_SE=use_SE, use_CBAM=use_CBAM, use_ASPP=use_ASPP, use_attn=use_attn)
