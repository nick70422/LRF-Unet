...
class SwinUnetTrainerV2(nnUNetTrainer):
    """
    ...
    def initialize_network(self, resume=False):
        ...
        #self.network = SwinUnet(3, 224, self.num_classes, conv_op, resume)
        self.network = SwinUnet(3, 512, self.num_classes, conv_op, resume)
        #self.network = SwinUnet(3, 256, self.num_classes, conv_op, resume)
    ...
    def plot_network_architecture(self):
        print("network plotting has been skipped in Swin-Unet")