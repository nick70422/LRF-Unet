...
class SwinUnet(SegmentationNetwork):
    def __init__(self, num_input_channels, img_size=224, num_classes=21843, conv_op=False, resume=False):
        ...
        if img_size == 224 and not resume:
            self.load_from()
    ...
    def load_from(self):
        ...
        if pretrained_path is not None:
            ...
            #msg = self.swin_unet.load_state_dict(full_dict)
            print(msg)
        else:
            print("none pretrain")
