...
if __name__ == '__main__':
    ...
    LITS_fixed_data_path = f'preprocessed_data/fold{args.fold}'
    model_path = f'/final checkpoints/Se_PPP_ResUNet_ce_NoS/fold{args.fold}/abdominal_segmentation_Se_PPP_ResUNet_ce_NoS_on_CSM_dataset_fold1_iter_8000.pth'
